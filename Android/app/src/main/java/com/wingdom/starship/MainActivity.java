...
public class MainActivity extends SDLActivity{
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        preferences = getSharedPreferences("com.wingdom.starship.prefs",Context.MODE_PRIVATE);

        // Using app-specific storage (getExternalFilesDir) - no permissions needed
        doVersionCheck();
        checkAndSetupFiles();
    ...
    private boolean controllerSetupDone = false;

    @Override
    public void onWindowFocusChanged(boolean hasFocus) {
        super.onWindowFocusChanged(hasFocus);

        // TODO: Touch controller overlay is disabled until JNI methods are implemented
        // To re-enable:
        // 1. Create Android/app/src/main/cpp/jni_controller.cpp with implementations like:
        //    extern "C" JNIEXPORT void JNICALL
        //    Java_com_wingdom_starship_MainActivity_attachController(JNIEnv* env, jobject obj) {
        //        // Implementation here
        //    }
        //
        //    extern "C" JNIEXPORT void JNICALL
        //    Java_com_wingdom_starship_MainActivity_setButton(JNIEnv* env, jobject obj, jint button, jboolean value) {
        //        // Implementation here
        //    }
        //    // Add similar implementations for: detachController, setAxis, setCameraState
        //
        // 2. Add the cpp file to CMakeLists.txt
        // 3. Uncomment the code below:
        /*
        if (hasFocus && !controllerSetupDone) {
    ...
    private void doVersionCheck(){
        ...
        if (currentVersion > storedVersion) {
            // Don't delete O2R files - user may have manually placed them
            // Only delete the assets folder which contains config files
    ...
    private void deleteOutdatedAssets() {
        ...
        File sf64File = new File(targetRootFolder, "sf64.o2r");
        File assetsFolder = new File(targetRootFolder, "assets");

        deleteIfExists(starshipFile);
        deleteIfExists(sf64File);
        deleteRecursiveIfExists(assetsFolder);
    }
        ...
        if (sourceOldRoot != null && sourceSavesDir.isDirectory()) {
            ...
            if (sourceFiles != null) {
                for (File file : sourceFiles) {
                    ...
                    if (name.equals("assets") || name.equals("starship.o2r") || name.equals("sf64.o2r")) {
                        continue; // Skip these
                    }
    ...
    private void setupControllerOverlay() {
        ...
        if (view == null) {
            Log.e("MainActivity", "getContentView() returned null, cannot setup controller overlay");
            return;
        }
